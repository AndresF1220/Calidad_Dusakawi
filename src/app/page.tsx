...
const sustainabilityTips = [
  ...
  },
  {
    ...
    position: 'top-2 right-1/4',
    color: 'text-emerald-500',
  },
];

const Tip = ({ tip }: { tip: (typeof sustainabilityTips)[0] }) => (
  <div className={cn('absolute w-48 text-center flex flex-col items-center gap-2', tip.position)}>
